...
const college = {
  ...
  navLinks: [
    ...
    { name: 'About', href: '/about' },
    {
      ...
      dropdown: [
        ...
        { label: 'Academic Director', href: '/administration/academic-director' },
        ...
        { label: 'RTI Act', href: '/administration/rti-act' },
        { label: 'Alumni Association', href: '/administration/alumni-association' },
        { label: 'Student Council', href: '/administration/student-council' },
        { label: 'Mandatory Disclosures', href: '/administration/mandatory-disclosures' },
      ],
    },
    {
      name: 'Admissions',
      ...
      dropdown: [
        ...
        { label: 'Merit List', href: '/admissions/merit-list' },
        { label: 'Selection List', href: '/admissions/selection-list' },
      ],
    },
    {
      name: 'Academics',
    ...
    },
    {
      ...
      dropdown: [
        ...
        { label: 'Co-Curricular', href: '/student-life/co-curricular' },
        { label: 'SEEKH', href: '/student-life/seek' },
        { label: 'NIPUN', href: '/student-life/nipun' },
        { label: 'DHI', href: '/student-life/dhi' },
        { label: 'Avishkar', href: '/student-life/avishkar' },
        { label: 'LICD', href: '/student-life/licd' },
      ],
    },
    {
      name: 'Infrastructure',
      ...
      dropdown: [
        { label: 'Infrastructure', href: '/infrastructure/overview' },
        { label: 'Sports Facilities', href: '/infrastructure/sports' },
        { label: 'Health Facilities', href: '/infrastructure/health' },
        { label: 'Physically Challenged', href: '/infrastructure/physically-challenged' },
        { label: 'Industry Connect', href: '/infrastructure/industry-connect' },
      ],
    },
    {
      name: 'Departments',
      ...
      dropdown: [
        ...
        { label: 'CSE — HOD', href: '/departments/cse/hod' },
        { label: 'CSE — Syllabus', href: '/departments/cse/syllabus' },
        { label: 'CSE — Faculty', href: '/departments/cse/faculty' },
        { label: 'B.E. (CSE AI & ML)', href: '/departments/cse-aiml' },
        { label: 'CSE AI&ML — HOD', href: '/departments/cse-aiml/hod' },
        { label: 'CSE AI&ML — Syllabus', href: '/departments/cse-aiml/syllabus' },
        { label: 'B.E. (IT)', href: '/departments/it' },
        { label: 'IT — HOD', href: '/departments/it/hod' },
        { label: 'IT — Syllabus', href: '/departments/it/syllabus' },
        { label: 'IT — Faculty', href: '/departments/it/faculty' },
        { label: 'B.E. (CS)', href: '/departments/cyber-security' },
        { label: 'CS — HOD', href: '/departments/cyber-security/hod' },
        { label: 'CS — Syllabus', href: '/departments/cyber-security/syllabus' },
        { label: 'B.E. (H&S)', href: '/departments/hs' },
        { label: 'H&S — HOD', href: '/departments/hs/hod' },
        { label: 'H&S — Faculty', href: '/departments/hs/faculty' },
      ],
    },
    {
      name: 'Research',
  ...
  quickLinks: [
    ...
    { label: 'Infrastructure', href: '/infrastructure/overview' },
    { label: 'Student Life', href: '/student-life/events' },
