      ...
      <div className="w-full bg-white py-2" style={{ borderBottom: `1px solid ${withAlpha(college.primaryColor, 0.1)}` }}>
        <div className="max-w-[1320px] mx-auto px-[60px] flex items-center gap-4">
          <div
            ...
            style={{
              backgroundColor: withAlpha(college.greenAccent, 0.07),
              borderColor: withAlpha(college.greenAccent, 0.28),
            }}
          >
            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20" style={{ color: college.greenAccent }}>
