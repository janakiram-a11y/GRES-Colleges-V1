    ...
    <section className="relative w-full h-[400px] sm:h-[500px] lg:h-[600px] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full section-pad flex justify-between items-center">
        <div className="flex flex-col gap-[14px] sm:gap-[18px] max-w-[686px]">
          <h1
            className="font-hind font-bold text-[28px] sm:text-[36px] lg:text-[48px] leading-tight lg:leading-[72px] text-white"
            style={{ filter: 'drop-shadow(0px 3px 3px rgba(0,0,0,0.12))' }}
          >
            {college.heroHeading}
          </h1>
          <p
            className="font-dm-sans font-normal text-[14px] sm:text-[16px] lg:text-[18px] leading-[22px] text-white/90"
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-wrap">
            <a
              ...
              className="bg-[#C32033] text-white font-dm-sans font-semibold text-[14px] sm:text-[16px] leading-6 px-6 sm:px-8 py-3 sm:py-[14px] rounded hover:bg-[#a81b2a] transition-colors inline-block"
              style={{ boxShadow: '0px 10px 15px -3px rgba(0,0,0,0.1), 0px 4px 6px -4px rgba(0,0,0,0.1)' }}
            >
              {college.heroCTALabel}
            </a>
            <button
              className="bg-white text-[#5B1027] font-dm-sans font-semibold text-[14px] sm:text-[16px] leading-6 px-6 sm:px-8 py-3 sm:py-[14px] rounded hover:bg-gray-50 transition-colors"
              style={{ boxShadow: '0px 10px 15px -3px rgba(0,0,0,0.1), 0px 4px 6px -4px rgba(0,0,0,0.1)' }}
            >
              Explore Programs
            </button>
